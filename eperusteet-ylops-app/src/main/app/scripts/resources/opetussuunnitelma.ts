...
ylopsApp
    ...
    .factory("OpetussuunnitelmaCRUD", function($resource, YlopsResources, SERVICE_LOC) {
        return $resource(
            ...
            },
            {
                ...
                opetussuunnitelmat: {
                    method: "GET",
                    url: SERVICE_LOC + "/opetussuunnitelmat/:opsId/opetussuunnitelmat",
                    isArray: true
                },
                opetussuunnitelmatSync: {
                    method: "POST",
                    url: SERVICE_LOC + "/opetussuunnitelmat/:opsId/opetussuunnitelmat",
                    isArray: false
                }
    ...
    .factory("OpetussuunnitelmanTekstit", function($resource, YlopsResources) {
        return $resource(
            YlopsResources.OPS + "/tekstit/:viiteId",
            {
                viiteId: "@id"
            },
            {
    ...
    .factory("OppiaineenVuosiluokkaLukko", function($resource, YlopsResources) {
        return $resource(
            YlopsResources.OPS + "/oppiaineet/:oppiaineId/vuosiluokkakokonaisuudet/:vlkId/vuosiluokat/:vlId/lukko"
        );
    })
    .factory("OpetusuunnitelmaLukio", function($resource, YlopsResources) {
        return $resource(
            YlopsResources.LUKIO_OPS,
            {},
            {
                aihekokonaisuudet: {
                    method: "GET",
                    url: YlopsResources.LUKIO_OPS + "/aihekokonaisuudet",
                    isArray: false
                },
                saveAihekokonaisuus: {
                    method: "POST",
                    url: YlopsResources.LUKIO_OPS + "/aihekokonaisuudet/kokonaisuus",
                    isArray: false
                },
                rearrangeAihekokonaisuudet: {
                    method: "POST",
                    url: YlopsResources.LUKIO_OPS + "/aihekokonaisuudet/jarjesta",
                    isArray: false
                },
                updateAihekokonaisuudetYleiskuvaus: {
                    method: "POST",
                    url: YlopsResources.LUKIO_OPS + "/aihekokonaisuudet/yleiskuvaus",
                    isArray: false
                },
                updateAihekokonaisuus: {
                    method: "POST",
                    url: YlopsResources.LUKIO_OPS + "/aihekokonaisuudet/kokonaisuus/:aihekokonaisuusId",
                    isArray: false
                },
                deleteAihekokonaisuus: {
                    method: "DELETE",
                    url: YlopsResources.LUKIO_OPS + "/aihekokonaisuudet/kokonaisuus/:aihekokonaisuusId",
                    isArray: false
                },
                ...
                opetuksenYleisetTavoitteet: {
                    method: "GET",
                    url: YlopsResources.LUKIO_OPS + "/opetuksenYleisetTavoitteet",
                    isArray: false
                },
                updateOpetuksenYleisetTavoitteet: {
                    method: "POST",
                    url: YlopsResources.LUKIO_OPS + "/opetuksenYleisetTavoitteet",
                    isArray: false
                },
                ...
                addKielitarjonta: {
                    method: "POST",
                    url: YlopsResources.LUKIO_OPS + "/oppiaine/:oppiaineId/kielitarjonta",
                    isArray: false
                },
                addAbstraktiOppiaine: {
                    method: "POST",
                    url: YlopsResources.LUKIO_OPS + "/oppiaine/abstrakti",
                    isArray: false
                },
                ...
                disconnectKurssi: {
                    method: "POST",
                    url: YlopsResources.LUKIO_OPS + "/oppiaine/:oppiaineId/kurssi/:kurssiId/disconnect",
                    isArray: false
                },
                reconnectKurssi: {
                    method: "POST",
                    url: YlopsResources.LUKIO_OPS + "/oppiaine/:oppiaineId/kurssi/:kurssiId/reconnect",
                    isArray: false
                },
                removeKurssi: {
                    method: "DELETE",
                    url: YlopsResources.LUKIO_OPS + "/kurssi/:kurssiId/remove",
                    isArray: false
                }
            }
        );
