...
ylopsApp
    ...
    .factory("EperusteetLukiokoulutus", function(UlkopuolisetResources, $resource) {
        return $resource(UlkopuolisetResources.ULKOPUOLISET + "lukiokoulutusperusteet/:perusteId", {
            perusteId: "@id"
        });
    })
    ...
    .factory("KoodistoHaku", function(UlkopuolisetResources, $resource) {
        return $resource(
            UlkopuolisetResources.ULKOPUOLISET + "koodisto/:koodistoUri",
            {
    ...
    .factory("PeruskouluHaku", function(UlkopuolisetResources, $resource) {
        return $resource(
            UlkopuolisetResources.ULKOPUOLISET + "organisaatiot/peruskoulut/oid/:oid",
            {
                oid: "@oid"
            },
            {
    ...
    .factory("LukioHaku", function(UlkopuolisetResources, $resource) {
        return $resource(
            UlkopuolisetResources.ULKOPUOLISET + "organisaatiot/lukiot/oid/:oid",
            {
                oid: "@oid"
            },
            {
    ...
    .factory("LukiotoimijaHaku", function(UlkopuolisetResources, $resource) {
        return $resource(
            UlkopuolisetResources.ULKOPUOLISET + "organisaatiot/lukiotoimijat/:kuntaUri",
            {
                kuntaUri: "@kuntaUri"
            },
            {
    ...
    .factory("PeruskoulutoimijaHaku", function(UlkopuolisetResources, $resource) {
        return $resource(
            UlkopuolisetResources.ULKOPUOLISET + "organisaatiot/peruskoulutoimijat/:kuntaUri",
            {
                kuntaUri: "@kuntaUri"
            },
            {
    ...
    .factory("Organisaatioryhmat", function(UlkopuolisetResources, $resource) {
        return $resource(
            UlkopuolisetResources.ULKOPUOLISET + "organisaatioryhmat/",
            {
                oid: "@oid"
            },
            {
