    ...
    $stateProvider
        .state("root.opetussuunnitelmat.yksi.opetus", {
            ...
            controller: [
                ...
                "VuosiluokatService",
                "opsModel",
                function($scope, $state, VuosiluokatService, opsModel) {
        ...
        .state("root.opetussuunnitelmat.yksi.opetus.vuosiluokkakokonaisuus", {
            ...
            resolve: {
                ...
                vlk: [
                    ...
                    "vlkId",
                    "opsId",
                    function(vuosiluokatService, vlkId, opsId) {
                ...
                baseLaajaalaiset: [
                    "vuosiluokatService",
                    "opsId",
                    function(vuosiluokatService, opsId) {
        ...
        .state("root.opetussuunnitelmat.yksi.opetus.oppiaine", {
            ...
            resolve: {
                versionHistory: [
                    "$stateParams",
                    "OppiaineCRUD",
                    ($stateParams, OppiaineCRUD) => {
                        return OppiaineCRUD.getVersions({
                ...
                perusteOppiaine: [
                    ...
                    "oppiaineInit",
                    "$stateParams",
                    function(vuosiluokatService, oppiaineId, oppiaineTyyppi, oppiaineInit) {
        ...
        .state("root.opetussuunnitelmat.yksi.opetus.oppiaine.vuosiluokka", {
            ...
            resolve: {
                ...
                vuosiluokkaSisalto: [
                    "VuosiluokkaCRUD",
                    "$stateParams",
                    function(VuosiluokkaCRUD, $stateParams) {
        ...
        .state("root.opetussuunnitelmat.yksi.opetus.uusioppiaine", {
            ...
            resolve: {
                ...
                vlkPeruste: [
                    ...
                    "opsId",
                    "Notifikaatiot",
                    function(vuosiluokatService, vlkId, opsId, Notifikaatiot) {
