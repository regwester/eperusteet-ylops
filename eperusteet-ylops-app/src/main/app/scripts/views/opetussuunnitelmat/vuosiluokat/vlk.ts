...
ylopsApp
    .service("VuosiluokkakokonaisuusMapper", function(VuosiluokatService, $stateParams) {
        ...
        this.init = function(scope, laajaalaisetosaamiset) {
            VuosiluokatService.getVlkPeruste(
                $stateParams.id,
                $stateParams.vlkId,
                function(res) {
                ...
                save: () =>
                    $q(resolve => {
                        ...
                        OpetussuunnitelmaCRUD.jarjestaOppiaineet(
                            ...
                            res =>
                                Notifikaatiot.fataali(_.has(res, "data.syy") ? res.data.syy : "tallennus-epaonnistui")
                        );
                    }),
                cancel: () =>
                    $q(resolve => {
    ...
    .controller("VuosiluokkakokonaisuusController", function(
        ...
        const fetch = () =>
            $q(resolve => {
                VuosiluokatService.getVuosiluokkakokonaisuus(
                    $stateParams.id,
                    $stateParams.vlkId,
                    res => {
                        $scope.vlk = res;
