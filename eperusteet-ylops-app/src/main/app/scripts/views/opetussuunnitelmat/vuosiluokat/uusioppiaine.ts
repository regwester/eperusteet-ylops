...
ylopsApp.controller("UusiOppiaineController", function(
    $scope,
    $stateParams,
    $state,
    $rootScope,
    ...
    MurupolkuData.set({
        osioNimi: "vuosiluokat-ja-oppiaineet",
        alueId: "vuosiluokat",
        vlkNimi: vlk.nimi,
        vlkId: vlk.id
    });
    ...
    $scope.options = {};
    $scope.tyypit = ["taide_taitoaine", "muu_valinnainen"];
