...
ylopsApp
    .factory("KasitteetResource", function($resource, SERVICE_LOC) {
        return $resource(
            SERVICE_LOC + "/opetussuunnitelmat/:opsId/termisto/:id",
            {
                opsId: "@opsId",
                id: "@id",
                avain: "@avain"
    ...
    .controller("KasitteetController", function(
        $scope,
        $stateParams,
        $modal,
        KasitteetService,
    ...
    .controller("KasitteetMuokkausController", function(
        $scope,
        termimodel,
        Varmistusdialogi,
        $modalInstance,
