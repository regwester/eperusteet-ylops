...
ylopsApp
    ...
    .controller("KielitarjontaModalController", function(
        $scope,
        $stateParams,
        $modalInstance,
        $q,
        ...
        var vuosiluokkakokonaisuudet = _(OpsService.get().vuosiluokkakokonaisuudet)
            .map("vuosiluokkakokonaisuus")
            .map("_tunniste")
            .value();
        vuosiluokkakokonaisuudet = _.zipObject(
            vuosiluokkakokonaisuudet,
            _.map(vuosiluokkakokonaisuudet, _.constant(true))
        );
