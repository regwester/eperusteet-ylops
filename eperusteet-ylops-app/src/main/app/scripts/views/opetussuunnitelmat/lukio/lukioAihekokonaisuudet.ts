...
ylopsApp
    .controller('AihekokonaisuudetController', function ($scope, $state, Editointikontrollit, $q,
                         LukioOpetussuunnitelmaService:LukioOpetussuunnitelmaServiceI, $timeout,
                         $stateParams, Notifikaatiot, Kaanna) {
        ...
        $scope.addAihekokonaisuus = () => {
            $timeout(() => $state.go('root.opetussuunnitelmat.lukio.opetus.uusiaihekokonaisuus', {
                id: $stateParams.id
            }));
        };
    })
    .controller('AihekokonaisuusController', function ($scope, $state, $stateParams, Varmistusdialogi,
                           Editointikontrollit, $q, $timeout, $log, Notifikaatiot, Kaanna,
        ...
        $scope.isDeletable = () => $scope.aihekokonaisuus && !$scope.aihekokonaisuus.perusteen
                && !$scope.aihekokonaisuus.parent;
    ...
    .controller('LuoAihekokonaisuusController', function ($scope, $state, $stateParams, Kaanna,
                        Editointikontrollit, $q, $timeout, LukioControllerHelpers, Notifikaatiot,
                        LukioOpetussuunnitelmaService:LukioOpetussuunnitelmaServiceI) {
        ...
        Editointikontrollit.registerCallback({
            ...
            save: () => $q((resolve) => {
                LukioOpetussuunnitelmaService.saveAihekokonaisuus($scope.aihekokonaisuus).then(res => {
                    Notifikaatiot.onnistui('aihekokonaisuuden-tallentaminen-onnistui');
                    $timeout(() => $state.go('root.opetussuunnitelmat.lukio.opetus.aihekokonaisuus', {
                        id: $stateParams.id,
