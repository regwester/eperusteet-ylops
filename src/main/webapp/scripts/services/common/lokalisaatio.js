...
ylopsApp.factory('LokalisointiResource', function(LOKALISOINTI_SERVICE_LOC, $resource) {
  return $resource(LOKALISOINTI_SERVICE_LOC + '?category=eperusteet', {}, {
    get: {
      method: 'GET',
      isArray: true,
      cache: true
...
ylopsApp.factory('LokalisointiLoader', function ($q, $http, LokalisointiResource, $window) {
  var PREFIX = 'localisation/',
      SUFFIX = '.json',
