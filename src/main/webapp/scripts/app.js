...
var ylopsApp = angular.module('ylopsApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'ylopsAppUtils', 'pascalprecht.translate', 'truncate', 'ngCacheBuster']);
