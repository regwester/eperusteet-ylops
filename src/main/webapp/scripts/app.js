...
ylopsApp.config(function ($routeProvider, $httpProvider, $translateProvider,
      tmhDynamicLocaleProvider, httpRequestInterceptorCacheBusterProvider, USER_ROLES) {
...
ylopsApp.run(function($rootScope, $location, $http, AuthenticationSharedService,
  Session, USER_ROLES) {
