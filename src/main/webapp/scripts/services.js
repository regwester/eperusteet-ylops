...
ylopsApp.factory('Register', function ($resource) {
        return $resource('app/rest/register', {}, {
        });
    });

ylopsApp.factory('Activate', function ($resource) {
        return $resource('app/rest/activate', {}, {
            'get': { method: 'GET', params: {}, isArray: false}
        });
    });

ylopsApp.factory('Account', function ($resource) {
        return $resource('app/rest/account', {}, {
        });
    });

ylopsApp.factory('Password', function ($resource) {
        return $resource('app/rest/account/change_password', {}, {
        });
    });

ylopsApp.factory('Sessions', function ($resource) {
        return $resource('app/rest/account/sessions/:series', {}, {
            'get': { method: 'GET', isArray: true}
        });
    });

ylopsApp.factory('MetricsService',function ($http) {
    		return {
            get: function() {
...
ylopsApp.factory('ThreadDumpService', function ($http) {
        return {
            dump: function() {
...
ylopsApp.factory('HealthCheckService', function ($rootScope, $http) {
        return {
            check: function() {
...
ylopsApp.factory('ConfigurationService', function ($rootScope, $filter, $http) {
    return {
        get: function() {
...
ylopsApp.factory('LogsService', function ($resource) {
...
ylopsApp.factory('AuditsService', function ($http) {
        return {
            findAll: function() {
