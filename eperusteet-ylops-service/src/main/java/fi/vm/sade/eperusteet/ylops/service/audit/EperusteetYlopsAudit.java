...
import fi.vm.sade.eperusteet.ylops.service.audit.LogMessage.LogMessageBuilder;
 ...
 */
@Component
public class EperusteetYlopsAudit {
    @Autowired
    private RevisionMetaService revisionMetaService;

    public static final Audit AUDIT = new Audit("eperusteet-ylops-service", ApplicationType.VIRKAILIJA);
