...
ALTER TABLE oppiaine ADD COLUMN valtakunnallinen_pakollinen_kuvaus_id INT8 REFERENCES tekstikappale(id);
ALTER TABLE oppiaine_aud ADD COLUMN valtakunnallinen_pakollinen_kuvaus_id INT8;
ALTER TABLE oppiaine ADD COLUMN valtakunnallinen_syventava_kuvaus_id INT8 REFERENCES tekstikappale(id);
ALTER TABLE oppiaine_aud ADD COLUMN valtakunnallinen_syventava_kuvaus_id INT8;
ALTER TABLE oppiaine ADD COLUMN valtakunnallinen_soveltava_kuvaus_id INT8 REFERENCES tekstikappale(id);
ALTER TABLE oppiaine_aud ADD COLUMN valtakunnallinen_soveltava_kuvaus_id INT8;

ALTER TABLE oppiaine ADD COLUMN paikallinen_pakollinen_kuvaus_id INT8 REFERENCES tekstikappale(id);
ALTER TABLE oppiaine_aud ADD COLUMN paikallinen_pakollinen_kuvaus_id INT8;
ALTER TABLE oppiaine ADD COLUMN paikallinen_syventava_kuvaus_id INT8 REFERENCES tekstikappale(id);
ALTER TABLE oppiaine_aud ADD COLUMN paikallinen_syventava_kuvaus_id INT8;
ALTER TABLE oppiaine ADD COLUMN paikallinen_soveltava_kuvaus_id INT8 REFERENCES tekstikappale(id);
